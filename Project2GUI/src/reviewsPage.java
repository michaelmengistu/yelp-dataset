 ...
 * 
 * TODO: fix this docmuentation and document the rest of this file
...
public class reviewsPage extends JFrame{
	...
	public reviewsPage(String business_id) throws SQLException {
		...
		queryResult = jdbcpostgreSQLGUI.queryDatabaseTable("SELECT * FROM reviews WHERE reviews.business_id LIKE \'" + business_id + "\'");
